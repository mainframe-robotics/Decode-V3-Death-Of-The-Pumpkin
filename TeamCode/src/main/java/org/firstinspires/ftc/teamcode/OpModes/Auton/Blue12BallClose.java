...
@Autonomous(name = "Blue12Ball", group = "Examples")
public class Blue12BallClose extends OpMode {
    ...
    private final Pose startPose = new Pose(21.63, 122.23, Math.toRadians(140));
    private final Pose shoot1Pose = new Pose(53, 91, Math.toRadians(180));
    ...
    private final Pose shoot2Pose = new Pose(66, 74, Math.toRadians(180));//old x: 50, y: 83.4

    private final Pose intake2Pose = new Pose(14, 35, Math.toRadians(180));
    private final Pose intake2PoseControl = new Pose(41, 31.5);
    private final Pose shoot3Pose = new Pose(59, 85, Math.toRadians(180));// old x: 70, y: 74
    private final Pose intake3Pose = new Pose(18, 81.5, Math.toRadians(180));
    private final Pose shoot4Pose = new Pose(50, 120, Math.toRadians(180));// old x: 70, y: 74
