...
public class Red12BallClose extends OpMode {
    ...
    private final Pose startPose = new Pose(24.86825056902067, 125.70476862389272, Math.toRadians(141.2697451694792)).mirror();
...
//    private final Pose intake2PoseControl = new Pose(41, 31.5);
    ...
    private final Pose leavePose = new Pose(40,84,Math.toRadians(180)).mirror();
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        scoreSet1 = follower.pathBuilder()
                ...
                .addParametricCallback(.75,()->follower.setMaxPower(.2))
                .setReversed()
                .build();
